...
const products = [
  ...
  },
  {
    ...
    badgeTextColor: "#F0ECD8",
    desc: "Thick, creamy buffalo milk. High in fat and protein, perfect for tea, coffee, and home-made curd.",
    features: ["500ml daily delivery", "High cream content", "Rich in Calcium", "Fresh by 7am"],
    image: "/buffalo-bottle.png",
    accentColor: "#52B788",
    bg: "linear-gradient(135deg, rgba(82,183,136,0.08), rgba(82,183,136,0.02))",
  },
  {
    id: "buffalo-1l",
    name: "Fresh Buffalo Milk",
    ...
    priceLabel: "₹89 / day",
    badge: "Value Pack",
    badgeGradient: "linear-gradient(135deg, #0D2B1D, #1B4332)",
    badgeTextColor: "#F0ECD8",
    desc: "Rich buffalo milk in a family-sized pack. Ideal for making traditional ghee and khoya at home.",
    features: ["1 Litre daily delivery", "Rich & Creamy", "No preservatives", "Fresh by 7am"],
    image: "/buffalo-bottle.png",
    accentColor: "#1B4332",
    bg: "linear-gradient(135deg, rgba(27,67,50,0.08), rgba(27,67,50,0.02))",
  },
  {
    id: "ghee-500",
  ...
  },
  {
    ...
    badgeGradient: "linear-gradient(135deg, #D4A017, #F5CC55)",
    badgeTextColor: "#0A0A0A",
    desc: "Authentic white butter (Makhan) churned from A2 curd. Pure, unsalted, and full of childhood memories.",
    features: ["Hand churned", "Unsalted purity", "No artificial color", "Rich in Vitamin A"],
    image: "/butter.png",
    accentColor: "#D4A017",
    bg: "linear-gradient(135deg, rgba(212,160,23,0.08), rgba(212,160,23,0.02))",
  },
  {
    ...
    badgeGradient: "linear-gradient(135deg, #2D6A4F, #52B788)",
    badgeTextColor: "#F0ECD8",
    desc: "Traditional Chaas made from A2 curd, infused with rock salt, roasted cumin, and fresh mint.",
    features: ["Cooling effect", "Natural electrolytes", "Daily fresh brew", "No preservatives"],
    image: "/buffalo-milk.png", // Using buffalo milk as proxy for buttermilk liquid
    accentColor: "#52B788",
    bg: "linear-gradient(135deg, rgba(82,183,136,0.08), rgba(82,183,136,0.02))",
  },
];
